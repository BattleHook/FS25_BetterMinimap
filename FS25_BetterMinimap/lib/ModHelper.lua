...
This utility class acts as a wrapper for Farming Simulator script based mods. It helps with setting up the mod up and 
...
function ModSettings:init(name, defaultSettingsFileName, userSettingsFileName)
    ...
    local modSettingsDir = getUserProfileAppPath() .. "modsSettings/" .. g_currentModName
